...
let totalNumberOfAnimals = numberOfRabbits + numberOfCats + numberOfTurtles + numberOfHamsters + numberOfPotBelliedPig + numberOfFish + numberOfSnakes

let totalNumberOfMammals = numberOfRabbits + numberOfCats + numberOfHamsters + numberOfPotBelliedPig
